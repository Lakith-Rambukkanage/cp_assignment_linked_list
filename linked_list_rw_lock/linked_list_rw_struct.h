...
#ifndef LINKED_LIST_RW_STRUCT_H_INCLUDED
#define LINKED_LIST_RW_STRUCT_H_INCLUDED
...
LinkedList *createLinkedList(){
    ...
    l_list->head = NULL;
    l_list->rwlock = PTHREAD_RWLOCK_INITIALIZER;
    return l_list;
}
...
#endif // LINKED_LIST_RW_STRUCT_H_INCLUDED
